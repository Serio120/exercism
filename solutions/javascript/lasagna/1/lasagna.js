...
//*********************************************
//export function remainingMinutesInOven() {
...
export function remainingMinutesInOven(realMinutesInOven) {
  return EXPECTED_MINUTES_IN_OVEN - realMinutesInOven;
}
...
export function preparationTimeInMinutes(numOfLayers) { 
  return numOfLayers * PREPARATION_MINUTES_PER_LAYER;
}
